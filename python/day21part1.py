...
#
#    * Determine which ingredients contain NO allergens
#
# QUESTION: What is the sum of all the times non-allergen ingredients appear
#           in the list?
import sys
import copy
...
print(non_allergenic_ingredients)
totCount=0
for i in non_allergenic_ingredients :
    totCount += masterIngredients[i]['c']

print("Part 1 answer (sum of appearances of non-allergenic ingredients) = ", totCount)
